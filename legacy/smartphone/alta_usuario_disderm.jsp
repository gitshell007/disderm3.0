...
<%@ page import="com.disderm.auth.Heimdall" %>
<%@ page import="com.disderm.service.SystemMailService" %>
<%@ page import="com.disderm.model.CustomAppUserModel" %>
...
<%
    /* HttpSessionNsession httpSession = request.getSession();
...
sBean.getUser().get_first_name()
    ...
    CustomAppUserModel customAppUserModel = new CustomAppUserModel();
    ...
    if (request.getParameter("isSubmit") != null) {
        ...
        is_processing = true;
        String nif = request.getParameter("dni").replaceAll(
                "[^a-zA-Z0-9]", "");
        if (!heimdall.existUser(request.getParameter("email"))) {
            DisdermusersDAO dao = new DisdermusersDAO();
            DisdermusersModel model = new DisdermusersModel();
            model.set_first_name(request.getParameter("nombre"));
            model.set_last_name(request.getParameter("apellidos"));
            /*Date date_fecha_nac = FFecha.getDate(request.getParameter("fecha_nacimiento"), FFecha.sdf_ddMMyyyy);
            if (date_fecha_nac == null) {
                date_fecha_nac = FFecha.getDate("01/01/2020", FFecha.sdf_ddMMyyyy);
            }
            customAppUserModel.(date_fecha_nac);
            pacientesModel.setDni(nif);
            pacientesModel.setNumero_historia(Long.valueOf(request.getParameter("numero_historia")));
            pacientesModel.setCodigo(Long.valueOf(request.getParameter("codigo")));
            pacientesModel.setFecha_alta_paciente(request.getParameter("fecha_alta_paciente"));
            pacientesModel.setTelefono1(request.getParameter("telefono1"));
            pacientesModel.setEmail(request.getParameter("email"));
            pacientesModel.setWeb_user(request.getParameter("web_user"));
            pacientesModel.setWeb_password(Crypto.encrypt(request.getParameter("web_password"), "SHA-512"));
            pacientesModel.set_app_enabled(1);
            pacientesModel.setFecha_alta_paciente(fecha_actual);
            pacientesModel.set_app_fecha_alta_sistema_string(FFecha.getString(fecha_actual, FFecha.sdf_ddMMyyyyBarHHmm));*/
            model.set_username(request.getParameter("usuario"));
            model.set_password(Crypto.encrypt(request.getParameter("web_password"), "SHA-512"));
            model.set_visible_name(request.getParameter("visible_name"));
            model.set_profile_image(request.getParameter("profile_image"));
            model.set_user_type_id(Integer.parseInt(request.getParameter("user_type_id")));
            model.set_profile_image(request.getParameter("profile_image"));
            model.set_enabled(Integer.parseInt(request.getParameter("enabled")));
            model.set_phone_mobile(request.getParameter("phone_mobile"));
            model.set_localidad(request.getParameter("localidad"));
            model.set_provincia(request.getParameter("provincia"));
            model.set_cp(request.getParameter("cp"));
            model.set_app_platform(request.getParameter("app_platform"));
            model.set_app_device_model(request.getParameter("app_device_model"));
            model.set_app_device_token(request.getParameter("app_device_token"));
            model.set_fecha_alta_sistema(Date.valueOf(request.getParameter("fecha_alta_sistema")));
            model.set_fecha_ultimo_acceso(Date.valueOf(request.getParameter("fecha_ultimo_acceso")));

            Long insertID = dao.insertDisdermusers(model);
            if (insertID != 0L) {
                sms.sendAltaAppdEmail(model.get_username(), request.getParameter("password"));
...
<head>
    ...
    <title>.:FEELFARMA:. Formulario de alta de usuario</title>
    <meta content="width=device-width, initial-scale=1.0, maximum-scale=1.0, user-scalable=no, shrink-to-fit=no"
          name="viewport">
    <meta content="FEELFARMA ALTA USUARIO" name="description">
                ...
                <div class="h-100 d-md-flex d-sm-block bg-white justify-content-center align-items-center col-md-12 col-lg-7">
                    <div class="mx-auto app-login-box col-sm-12 col-md-10 col-lg-9">
                        ...
                        <div class="app-logo-gineapp">
                            <img alt="Feelfarma" height="82" longdesc="https://www.feelfarma.com"
                                 src="assets/images/feelfarma/feelfarma_logo.png'" width="340"/>
                            <div></div>
                        </div>
                        <%
                            if (!is_processing) {
                        ...
                        <div class="app-footer-gineapp">
                            <footer>
                                <small>&copy; Copyright 2021, Feelfarma <%=Varios.getVersion()%>
                                </small>
                            </footer>
                        </div>
                    </div>
                        ...
                        <div class="slick-slider">
                            <div class="h-100 d-flex justify-content-center align-items-center bg-premium-dark"
                                ...
                                <!--<div class="slide-img-bg"
                                     style="background-image: url('assets/images/backoffice/feelfarma_logo.png');"></div>-->
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="button" class="btn btn-primary" <%=botonModalTerminos%>>Acepto</button>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <p style="line-height: 1;"><span style="font-size: 16px;"><span
                                style="font-family: Tahoma,Geneva, sans-serif;">soporte@feelfarma.com</span></span></p>
                        <p style="line-height: 1;"><span style="font-size: 16px;"><span
                        ...
                        <p style="line-height: 1;"><span style="font-size: 16px;"><span
                                style="font-family: Tahoma,Geneva, sans-serif;">&bull; &nbsp; &nbsp;sea estrictamente necesario para la prestaci&oacute;n de los servicios solicitados, en caso que FEELFARMA colabore con terceros</span></span>
                        </p>
                        <p style="line-height: 1;"><span style="font-size: 16px;"><span
                                style="font-family: Tahoma,Geneva, sans-serif;">&bull; &nbsp; &nbsp;cuando FEELFARMA tenga autorizaci&oacute;n expresa e inequ&iacute;voca por parte del usuario</span></span>
                        </p>
                        <p style="line-height: 1;"><span style="font-size: 16px;"><span
                        ...
                        <p style="line-height: 1;"><span style="font-size: 16px;"><span
                                style="font-family: Tahoma,Geneva, sans-serif;">&bull; &nbsp; &nbsp;si lo requiere la ley. FEELFARMA mantendr&aacute; un registro de transmisi&oacute;n de datos incluyendo&nbsp;</span></span>
                        </p>
                        <p style="line-height: 1;"><span style="font-size: 16px;"><span
                        ...
                        <p style="line-height: 1;"><span style="font-size: 16px;"><span
                                style="font-family: Tahoma,Geneva, sans-serif;"><br></span></span></p>
                        <p style="line-height: 1;"><span style="font-size: 16px;"><span
                                style="font-family: Tahoma,Geneva, sans-serif;">Las presentes Condiciones Generales de Uso tienen por objeto regular las condiciones de acceso y utilizaci&oacute;n de la aplicaci&oacute;n, as&iacute; como los servicios proporcionados a trav&eacute;s de dispositivos m&oacute;viles del usuario (en adelante, la &ldquo;Aplicaci&oacute;n&rdquo;), por parte de su titular, Centro de Ginecolog&iacute;a y Diagn&oacute;stico Prenatal Doctor Chac&oacute;n S.L., con domicilio en C/ Asunci&oacute;n N&ordm; 84, 2&ordm;C, CP 41011, Sevilla, inscrita en el Registro Mercantil de al tomo 4469, folio 130 hoja 69283, en adelante Feelfarma</span></span>
                        </p>
                        <p style="line-height: 1;"><span style="font-size: 16px;"><span
                                style="font-family: Tahoma,Geneva, sans-serif;">Feelfarma pone a disposici&oacute;n de los usuarios la direcci&oacute;n de correo soporte@feelfarma.com &nbsp;para que puedan plantear cualquier duda sobre las presentes Condiciones Generales de Uso y el funcionamiento de la Aplicaci&oacute;n.</span></span>
                        </p>
                        <p style="line-height: 1;"><span style="font-size: 16px;"><span
                                style="font-family: Tahoma,Geneva, sans-serif;">A los efectos de las presentes Condiciones Generales de Uso, se entender&aacute; por usuario la persona que acceda, navegue, utilice o participe en los servicios de Feelfarma, de conformidad con lo dispuesto a continuaci&oacute;n.</span></span>
                        </p>
                        <p style="line-height: 1;"><span style="font-size: 16px;"><span
                        ...
                        <p style="line-height: 1;"><span style="font-size: 16px;"><span
                                style="font-family: Tahoma,Geneva, sans-serif;">Asimismo, la utilizaci&oacute;n por parte del usuario de los servicios de Feelfarma supone, en todo caso, la adhesi&oacute;n a las presentes Condiciones Generales de Uso en la versi&oacute;n publicada en el momento mismo de utilizaci&oacute;n de la Aplicaci&oacute;n.</span></span>
                        </p>
                        <p style="line-height: 1;"><span style="font-size: 16px;"><span
                        ...
                        <p style="line-height: 1;"><span style="font-size: 16px;"><span
                                style="font-family: Tahoma,Geneva, sans-serif;">2. SERVICIOS Y FUNCIONAMIENTO DE Feelfarma</span></span>
                        </p>
                        <p style="line-height: 1;"><span style="font-size: 16px;"><span
                                style="font-family: Tahoma,Geneva, sans-serif;">La Aplicaci&oacute;n ha sido creada para, ofrecer informaci&oacute;n de salud de forma estructurada Los servicios incluidos en Feelfarma son:</span></span>
                        </p>
                        <p style="line-height: 1;"><span style="font-size: 16px;"><span
                        ...
                        <p style="line-height: 1;"><span style="font-size: 16px;"><span
                                style="font-family: Tahoma,Geneva, sans-serif;">Los usuarios deber&aacute;n facilitar informaci&oacute;n a Feelfarma de la que sean titulares, evitando la vulneraci&oacute;n de derechos de terceros y, en particular, derechos de propiedad intelectual o industrial y derechos de imagen. En el supuesto de que los usuarios incumplan dicha obligaci&oacute;n, responder&aacute;n frente a terceros de los da&ntilde;os y perjuicios ocasionados, manteniendo indemne en todo momento a Feelfarma.</span></span>
                        </p>
                        <p style="line-height: 1;"><span style="font-size: 16px;"><span
                        ...
                        <p style="line-height: 1;"><span style="font-size: 16px;"><span
                                style="font-family: Tahoma,Geneva, sans-serif;">- Bloquear, sobrescribir, modificar o copiar los contenidos de la Aplicaci&oacute;n, a no ser que ello sea necesario para la correcta utilizaci&oacute;n de los servicios de Feelfarma;</span></span>
                        </p>
                        <p style="line-height: 1;"><span style="font-size: 16px;"><span
                        ...
                        <p style="line-height: 1;"><span style="font-size: 16px;"><span
                                style="font-family: Tahoma,Geneva, sans-serif;">Feelfarma podr&aacute; denegar o retirar el acceso a la Aplicaci&oacute;n a los usuarios que incumplan las presentes Condiciones Generales de Uso, sin necesidad de preaviso alguno. Los usuarios que incumplan las presentes Condiciones Generales de Uso responder&aacute;n de todos los da&ntilde;os y perjuicios que se deriven de su actuaci&oacute;n.</span></span>
                        </p>
                        <p style="line-height: 1;"><span style="font-size: 16px;"><span
                                style="font-family: Tahoma,Geneva, sans-serif;">4. RESPONSABILIDAD DE Feelfarma</span></span>
                        </p>
                        <p style="line-height: 1;"><span style="font-size: 16px;"><span
                                style="font-family: Tahoma,Geneva, sans-serif;">4.1. &nbsp; &nbsp; Exclusi&oacute;n de responsabilidad</span></span>
                        </p>
                        <p style="line-height: 1;"><span style="font-size: 16px;"><span
                                style="font-family: Tahoma,Geneva, sans-serif;">Feelfarma se reserva el derecho de editar, actualizar, modificar, suspender, eliminar o finalizar los servicios ofrecidos por la Aplicaci&oacute;n, incluyendo todo o parte de su contenido, sin necesidad de previo aviso, as&iacute; como de modificar la forma o tipo de acceso a esta.  Las posibles causas de modificaci&oacute;n pueden tener lugar por motivos tales como su adaptaci&oacute;n a las posibles novedades legislativas y cambios en la propia Aplicaci&oacute;n, as&iacute; como a las que se puedan derivar de los c&oacute;digos tipos existentes en la materia o por motivos estrat&eacute;gicos o corporativos.  Feelfarma no ser&aacute; responsable del uso de la APLICACI&Oacute;N por un menor de edad, siendo la descarga y uso de la APLICACI&Oacute;N exclusiva responsabilidad del usuario.</span></span>
                        </p>
                        <p style="line-height: 1;"><span style="font-size: 16px;"><span
                                style="font-family: Tahoma,Geneva, sans-serif;">4.2. &nbsp; &nbsp; Responsabilidad por los servicios ofrecidos.</span></span>
                        </p>
                        <p style="line-height: 1;"><span style="font-size: 16px;"><span
                                style="font-family: Tahoma,Geneva, sans-serif;">Los servicios ofrecidos por Feelfarma son de car&aacute;cter exclusivamente informativo para los usuarios.</span></span>
                        </p>
                        <p style="line-height: 1;"><span style="font-size: 16px;"><span
                                style="font-family: Tahoma,Geneva, sans-serif;">Bajo ninguna circunstancia los usuarios deben utilizar la informaci&oacute;n ofrecida por Feelfarma para automedicarse.</span></span>
                        </p>
                        <p style="line-height: 1;"><span style="font-size: 16px;"><span
                                style="font-family: Tahoma,Geneva, sans-serif;">Feelfarma &nbsp;excluye cualquier tipo de responsabilidad por los da&ntilde;os y perjuicios de toda naturaleza que puedan deberse a la falta de veracidad, exactitud, exhaustividad y/o actualidad de los contenidos.</span></span>
                        </p>
                        <p style="line-height: 1;"><span style="font-size: 16px;"><span
                                style="font-family: Tahoma,Geneva, sans-serif;">La Informaci&oacute;n transmitida por Feelfarma est&aacute;n basan en la veracidad y exactitud de la informaci&oacute;n facilitada por el usuario. Consiguientemente, Feelfarma no se hace responsable de la falta de veracidad, exactitud y exhaustividad de los contenidos debida al incumplimiento del usuario de facilitar informaci&oacute;n veraz y exacta a trav&eacute;s de la consultas.</span></span>
                        </p>
                        <p style="line-height: 1;"><span style="font-size: 16px;"><span
                                style="font-family: Tahoma,Geneva, sans-serif;">Feelfarma no recomienda ni valida el uso de un f&aacute;rmaco en concreto o un determinado diagn&oacute;stico cl&iacute;nico, ni recomienda terapia alguna. Feelfarma es una fuente de informaci&oacute;n.&nbsp;</span></span>
                        </p>
                        <p style="line-height: 1;"><span style="font-size: 16px;"><span
                                style="font-family: Tahoma,Geneva, sans-serif;">4.3. &nbsp; &nbsp; Responsabilidad por el funcionamiento de la Aplicaci&oacute;n.</span></span>
                        </p>
                        <p style="line-height: 1;"><span style="font-size: 16px;"><span
                                style="font-family: Tahoma,Geneva, sans-serif;">Feelfarma no se hace responsable de los perjuicios que se pudieran derivar de interferencias, omisiones, interrupciones, virus inform&aacute;ticos, aver&iacute;as y/o desconexiones en el funcionamiento operativo de este sistema electr&oacute;nico o en los aparatos y equipos inform&aacute;ticos de los usuarios, motivadas por causas ajenas a Feelfarma, que impidan o retrasen la prestaci&oacute;n de los servicios o la navegaci&oacute;n por la Aplicaci&oacute;n, ni de los retrasos o bloqueos en el uso causados por deficiencias o sobrecargas de Internet o en otros sistemas electr&oacute;nicos, ni de la imposibilidad de dar el servicio o permitir el acceso por causas no imputables a Feelfarma, debidas a los usuarios, a terceros, o a supuestos de fuerza mayor.&nbsp;</span></span>
                        </p>
                        <p style="line-height: 1;"><span style="font-size: 16px;"><span
                                style="font-family: Tahoma,Geneva, sans-serif;">Feelfarma no se hace responsable por los da&ntilde;os y perjuicios de toda naturaleza que pudieran derivarse de la disponibilidad y continuidad t&eacute;cnica del funcionamiento de la Aplicaci&oacute;n. En cualquier caso, Feelfarma llevar&aacute; a cabo todas las actuaciones necesarias para restablecer sus servicios en caso de fallo t&eacute;cnico.</span></span>
                        </p>
                        <p style="line-height: 1;"><span style="font-size: 16px;"><span
                                style="font-family: Tahoma,Geneva, sans-serif;">Todo usuario de esta Aplicaci&oacute;n se compromete a mantener indemne a Feelfarma de cualquier reclamaci&oacute;n derivada de problemas surgidos por las causas descritas en el presente apartado.</span></span>
                        </p>
                        <p style="line-height: 1;"><span style="font-size: 16px;"><span
                                style="font-family: Tahoma,Geneva, sans-serif;">4.4. &nbsp; &nbsp; Responsabilidad de uso</span></span>
                        </p>
                        <p style="line-height: 1;"><span style="font-size: 16px;"><span
                                style="font-family: Tahoma,Geneva, sans-serif;">La responsabilidad de uso de la APLICACI&Oacute;N corresponde solo al usuario. Salvo lo establecido en estos T&eacute;rminos y Condiciones, Feelfarma no es responsable de ninguna p&eacute;rdida o da&ntilde;o que se produzca en relaci&oacute;n con la descarga o el uso de la APLICACI&Oacute;N, tales como los producidos a consecuencia de fallos, aver&iacute;as o bloqueos en el funcionamiento de la APLICACI&Oacute;N (por ejemplo, y sin car&aacute;cter limitativo: error en las l&iacute;neas de comunicaciones, defectos en el hardware o software de la APLICACI&Oacute;N o fallos en la red de Internet). Igualmente, Feelfarma tampoco ser&aacute; responsable de los da&ntilde;os producidos a consecuencia de un uso indebido o inadecuado de la APLICACI&Oacute;N por parte de los usuarios</span></span>
                        </p>
                        <p style="line-height: 1;"><span style="font-size: 16px;"><span
                                style="font-family: Tahoma,Geneva, sans-serif;">5. DERECHOS DE PROPIEDAD INDUSTRIAL E INTELECTUAL</span></span>
                        </p>
                        <p style="line-height: 1;"><span style="font-size: 16px;"><span
                                style="font-family: Tahoma,Geneva, sans-serif;">Los derechos de propiedad intelectual e industrial sobre la APLICACI&Oacute;N son titularidad Feelfarma, correspondi&eacute;ndole el ejercicio exclusivo de los derechos de explotaci&oacute;n de los mismos en cualquier forma y, en especial, los derechos de reproducci&oacute;n, distribuci&oacute;n, comunicaci&oacute;n p&uacute;blica y transformaci&oacute;n.</span></span>
                        </p>
                        <p style="line-height: 1;"><span style="font-size: 16px;"><span
                                style="font-family: Tahoma,Geneva, sans-serif;"> Los terceros titulares de derechos de propiedad intelectual e industrial sobre fotograf&iacute;as, logotipos, y cualesquiera otros s&iacute;mbolos o contenidos incluidos en la APLICACI&Oacute;N han concedido las correspondientes autorizaciones para su reproducci&oacute;n, distribuci&oacute;n y puesta a disposici&oacute;n del p&uacute;blico.  El usuario reconoce que la reproducci&oacute;n, modificaci&oacute;n, distribuci&oacute;n, comercializaci&oacute;n, descompilaci&oacute;n, desensamblado, utilizaci&oacute;n de t&eacute;cnicas de ingenier&iacute;a inversa o de cualquier otro medio para obtener el c&oacute;digo fuente, transformaci&oacute;n o publicaci&oacute;n de cualquier resultado de pruebas de referencias no autorizadas de cualquiera de los elementos y utilidades integradas dentro del desarrollo constituye una infracci&oacute;n de los derechos de propiedad intelectual de Feelfarma, oblig&aacute;ndose, en consecuencia, a no realizar ninguna de las acciones mencionadas</span></span>
                        </p>
                        <p style="line-height: 1;"><span style="font-size: 16px;"><span
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-secondary" data-dismiss="modal">Cancelar</button>
                        <button type="button" class="btn btn-primary" <%=botonModalPrivacidad%>>Acepto</button>
                    </div>
                </div>
            </div>
        </div>
