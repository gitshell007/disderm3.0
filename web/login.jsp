...
<head>
    ...
    <title>Login - Acceso usuarios</title>
    <meta name="viewport"
          content="width=device-width, initial-scale=1, maximum-scale=1, user-scalable=no, shrink-to-fit=no">
    <meta name="description" content="disderm">

    <!-- Disable tap highlight on IE -->
    <meta name="msapplication-tap-highlight" content="no">

    <link href="css_framework.css" rel="stylesheet">
    <link rel="icon" href="assets/images/disderm/favicon/favicon.ico" type="image/ico"/>
</head>
...
<div class="app-container app-theme-white body-tabs-shadow">
                        ...
                        <div class="slick-slider slick-initialized slick-dotted">
                            ...
                            <div class="slick-list draggable">
                                <div class="slick-track"
                                     style="opacity: 1; width: 4270px; transform: translate3d(-610px, 0px, 0px);">
                                    <div class="slick-slide slick-current slick-active" id="slick-slide00" data-slick-index="0" aria-hidden="true"
                                         tabindex="-1" style="width: 610px;">
                                        <div>
                                            <div style="width: 100%; display: inline-block;">
                                                <div class="h-100 d-flex justify-content-center align-items-center bg-sunny-morning"
                                                     tabindex="-1">
                                                    <div class="slide-img-bg"
                                                         style="background-image: url('assets/images/disderm/dosa_back1.jpg');"></div>
                                                    <div class="slider-content"><h3>Slogan </h3>
                                                        <p>Para cambiar</p></div>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="slick-slide slick-cloned" data-slick-index="1"
                                         aria-hidden="false" role="tabpanel" id="slick-slide01" style="width: 610px;">
                                        <div>
                                            <div style="width: 100%; display: inline-block;">
                                                <div class="h-100 d-flex justify-content-center align-items-center bg-plum-plate"
                                                     tabindex="-1">
                                                    <div class="slide-img-bg"
                                                         style="background-image: url('assets/images/disderm/dosa_back2.jpeg');"></div>
                                                    <div class="slider-content"><h3>Medicamentos</h3>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="slick-slide slick-cloned" id="slick-slide02" data-slick-index="2" aria-hidden="true"
                                         tabindex="-1" style="width: 610px;">
                                        <div>
                                            <div style="width: 100%; display: inline-block;">
                                                <div class="h-100 d-flex justify-content-center align-items-center bg-plum-plate"
                                                    ...
                                                    <div class="slide-img-bg"
                                                         style="background-image: url('assets/images/disderm/dosa_back2.jpeg');"></div>
                                                    <div class="slider-content"><h3>Farmacias</h3>
                                                        </div>
                                                </div>
                                            </div>
                                        </div>
                    ...
                    <div class="mx-auto app-login-box col-sm-12 col-md-10 col-lg-9">
                        <div class="mx-auto app-login-box col-sm-12 col-md-10 col-lg-9">
                            ...
                            <div class="app-logo-disderm">
                                <img alt="disderm" longdesc="http://backoffice.disderm.com"
                                     src="assets/images/disderm/disderm-logo.jpeg" width="400"/>

                            </div>

                            <h4 class="mb-0">
                                <span class="d-block">Bienvenido,</span>
                                <span>Por favor haz login en tu cuenta.</span></h4>

                            <div class="divider row"></div>
                            <div>
                                <form class="" action="auth/check.jsp" method="post">
                                    <div class="form-row">
                                        <div class="col-md-6">
                                            <div class="position-relative form-group"><label for="exampleEmail"
                                                                                             class="">Usuario:</label><input
                                                    name="username" id="exampleEmail" placeholder="usuario..."
                                                     class="form-control"></div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="position-relative form-group"><label for="examplePassword"
                                                                                             class="">Contraseña</label><input
                                                    name="password" id="examplePassword"
                                                    placeholder="Introduzca su password" type="password"
                                                    class="form-control"></div>
                                        </div>
                                    </div>
                                    <div class="position-relative form-check"><input name="check" id="exampleCheck"
                                            ...
                                            for="exampleCheck" class="form-check-label">Mantenme conectado</label></div>
                                    <div class="divider row"></div>
                                    <div class="d-flex align-items-center">
                                        <div class="ml-auto"><a href="javascript:void(0);" class="btn-lg btn btn-link">Recuperar
                                            contraseña</a>
                                            <button class="btn btn-primary btn-lg" style="background-color: #b42d8f">Acceso a Panel</button>
                                        </div>
                                    </div>
                                    ...
                                    <input type="hidden" name="login_hash" value="<%=hash%>">
                                </form>
                            </div>
                        </div>
                    </div>
    ...
    <script type="text/javascript" src="assets/framework/scripts_framework.js"></script>
