...
<!DOCTYPE html>
<!-- saved from url=(0056)https://intranet.gineapp.com:10000/backoffice/login.html -->
<html lang="es">
<head>
...
<link rel="icon" href="${pageContext.request.contextPath}/assets/images/gineapp/favicon.ico" type="image/ico"/>
</head>
                            ...
                            <div class="slick-list draggable">
                                <div class="slick-track"
                                                ...
                                                <div class="h-100 d-flex justify-content-center align-items-center bg-sunny-morning"
                                                    ...
                                                    <div class="slider-content"><h3>Complex, but lightweight</h3>
                                                        <p>We've included a lot of components that cover almost all use
                                                            cases for any type of application.</p></div>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="slick-slide slick-current slick-active" data-slick-index="0"
                                         aria-hidden="false" role="tabpanel" id="slick-slide00" style="width: 610px;">
                                        <div>
                                            <div style="width: 100%; display: inline-block;">
                                                <div class="h-100 d-flex justify-content-center align-items-center bg-plum-plate"
                                                    ...
                                                    <div class="slider-content"><h3>Enseñale al mundo..</h3>
                                                        <p>Lo más importantede tu vida viene en camino..</p></div>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="slick-slide" data-slick-index="1" aria-hidden="true" tabindex="-1"
                                         role="tabpanel" id="slick-slide01" style="width: 610px;">
                                        <div>
                                            <div style="width: 100%; display: inline-block;">
                                    ...
                                    <div class="slick-slide" data-slick-index="2" aria-hidden="true" tabindex="-1"
                                         role="tabpanel" id="slick-slide02" style="width: 610px;">
                                        <div>
                                            <div style="width: 100%; display: inline-block;">
                                                <div class="h-100 d-flex justify-content-center align-items-center bg-sunny-morning"
                                                     tabindex="-1">
                                            ...
                                            <div style="width: 100%; display: inline-block;">
                                                <div class="h-100 d-flex justify-content-center align-items-center bg-plum-plate"
                                                    ...
                                                    <div class="slider-content"><h3>Perfect Balance</h3>
                                                        <p>KeroUI is like a dream. Some think it's too good to be true!
                                                            Extensive collection of unified React Boostrap Components
                                                            and Elements.</p></div>
                                                </div>
                                            </div>
                                        </div>
                ...
                <div class="h-100 d-flex bg-white justify-content-center align-items-center col-md-12 col-lg-8">
                    <div class="mx-auto app-login-box col-sm-12 col-md-10 col-lg-9">
                        <div class="mx-auto app-login-box col-sm-12 col-md-10 col-lg-9">
                            ...
                            <h6 class="mt-3">¿No tienes cuenta? <a href="javascript:void(0);" class="text-primary">Suscribirse
                                ahora!</a></h6>
                                ...
                                <form class="">
                                    <div class="form-row">
                                        <div class="col-md-6">
                                            <div class="position-relative form-group"><label for="exampleEmail"
                                                    ...
                                                    name="email" id="exampleEmail" placeholder="Email aqui..."
                                        ...
                                        <div class="col-md-6">
                                            <div class="position-relative form-group"><label for="examplePassword"
                                                    ...
                                                    placeholder="Contraseña aqui..." type="password"
                                    ...
                                    <div class="d-flex align-items-center">
                                        <div class="ml-auto"><a href="javascript:void(0);" class="btn-lg btn btn-link">Recuperar
                                            contraseña</a>
                                            <button class="btn btn-primary btn-lg">Acceso a Panel</button>
                                        </div>
                                    </div>
                                </form>
                            </div>
