...
<%@ page import="com.disderm.model.UsertypeModel" %>
<%@ page import="com.disderm.dao.UsertypeDAO" %>
...
<%
    ...
    String user_icon = "/panel/assets_intranet/backoffice/feelfarma_user.png";
    if (request.getParameter("isSubmit") != null) {
        funcion = "openInsertModal();";
        UsertypeModel user_typeModel = new UsertypeModel();
        UsertypeDAO user_typeDAO = new UsertypeDAO();

        user_typeModel.set_user_type_des(request.getParameter("user_type_des"));
        user_typeModel.set_user_type_code(request.getParameter("user_type_code"));
        Long insertID = user_typeDAO.insertUsertype(user_typeModel);
        if (insertID != 0L) {
    ...
    <div class="app-main">
        ...
        <div class="app-main__outer">
            <div class="app-main__inner">
                ...
                <%=MainView.getTopBar("Insertar user_type", "Formulario de introducci&oacute;n para user_type", visible_name, username, user_icon)%>
                <!-- END HEADER TOP BAR -->
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="main-card mb-3 card">
                                                <div class="card-body">
                                                    <!-- CONTENIDO -->
                                                    <form id="insertarUsertypeForm" name="insertarUsertypeForm">
                                                        <div class="position-relative row form-group"><label
                                                                for="user_type_des"
                                                                class="col-sm-2 col-form-label">Descripcion</label>
                                                            <div class="col-sm-10"><input name="user_type_des"
                                                                                          id="user_type_des"
                                                        ...
                                                        <div class="position-relative row form-group"><label
                                                            ...
                                                            <div class="col-sm-10"><input name="user_type_code"
                                                                                          id="user_type_code"
                                                                                          placeholder="Codigo"
                                                                                          type="text"
                                                                                          class="form-control">
                                                        ...
                                                        <div class="position-relative row">
                                                            <div class="col-sm-12">
                                                                <button class="btn btn-primary form-group"
                                                                        onclick="actionInsertarUsertype()"
                                                                        style="width: inherit;">
                                                                    Insertar
                                                                </button>
...
<script>
    ...
    const form = $("#insertarUsertypeForm");
    const lockModal = $("#lock-modal");
    const loadingCircle = $("#loading-circle");
    var actionInsertarUsertype = function () {
    ...
    $(document).ready(() => {
        ...
        $('#avisoBorrarModal').on('hidden.bs.modal', function () {
            console.log('x');
            window.location.replace("/panel/modulos/parcelas/tbl_custom_search_parcelas.jsp");
        });
