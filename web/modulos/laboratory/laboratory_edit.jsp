...
<%
    ...
    if (request.getParameter("isSubmit") != null) {
        if (request.getParameter("action").equals("Edit")) {
            ...
            Long laboratory_id = Long.parseLong(request.getParameter("laboratory_id"));
            laboratorydao.updateLaboratoryString(map,laboratory_id);
        ...
        laboratoryModel = laboratorydao.getLaboratoryModelByID(id);
    }
    ...
    <div class="app-main">
        ...
        <div class="app-main__outer">
            <div class="app-main__inner">
                ...
                <%=MainView.getTopBar("Laboratory Edit", "Formulario de edicio&oacute;n para Laboratory", visible_name, username, user_icon)%>
                <!-- END HEADER TOP BAR -->
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="main-card mb-3 card">
                                                <div class="card-body">
                                                  <!-- CONTENIDO -->
                                                    <form id="laboratoryEditForm" name="laboratoryEditForm" method="post">
                                                        <div class="position-relative row form-group"><label
                                                            ...
                                                            <div class="col-sm-10"><input name="description"
                                                                                          ...
                                                                                          type="text"
                                                                                          class="form-control"
                                                                                          value="<%= laboratoryModel.get_description()%>">
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="position-relative row">
                                                            <div class="col-sm-12">
                                                                <button class="btn btn-primary form-group"
                                                                        onclick="actionLaboratoryEdit()"
                                                                        style="width: inherit;">
                                                                    Editar
                                                                </button>
                                                                <input type="hidden" name="laboratory_id" id="laboratory_id" value="<%=id%>">
...
<script>
    ...
    const form = $("#laboratoryEditForm");
    const lockModal = $("#lock-modal");
    const loadingCircle = $("#loading-circle");
    var actionLaboratoryEdit = function () {
        $('#action').val('Edit');
        var editForm = $('#laboratoryEditForm');
        editForm.submit();
    }

    $("laboratoryEditForm").submit(function(){

    });

    $(document).ready(() => {
        $("#laboratoryEditForm").validate({
            rules: {
                description:
                    {
                        required: true,
