...
<%@ page import="com.disderm.service.LaboratoryService" %>
...
<%
    ...
    if (request.getParameter("isSubmit") != null) {
        ...
        boolean resultService = LS.serviceInsertLaboratory(description);
        if (resultService) {
    ...
    <div class="app-main">
        ...
        <div class="app-main__outer">
            <div class="app-main__inner">
                ...
                <%=MainView.getTopBar("Laboratory insert", "Formulario de introducci&oacute;n para Laboratory", visible_name, username, user_icon)%>
                <!-- END HEADER TOP BAR -->
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="main-card mb-3 card">
                                                <div class="card-body">
                                                    <!-- CONTENIDO -->
                                                    <form id="laboratoryInsertForm" name="laboratoryInsertForm">
                                                        ...
                                                        <div class="position-relative row">
                                                            <div class="col-sm-12">
                                                                <button class="btn btn-primary form-group"
                                                                        onclick="laboratoryInsertAction()"
                                                                        style="width: inherit;">
                                                                    Insertar
                                                                </button>
...
<script>
    ...
    const form = $("#laboratoryInsertForm");
    const lockModal = $("#lock-modal");
    const loadingCircle = $("#loading-circle");
    var laboratoryInsertAction = function () {
    ...
    $(document).ready(() => {
        ...
        $('#avisoBorrarModal').on('hidden.bs.modal', function () {
            console.log('x');
            window.location.replace("/backoffice/modulos/laboratory/tbl_custom_search_laboratory.jsp");
        });
