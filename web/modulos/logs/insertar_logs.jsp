        ...
        <%@ page import="com.disderm.model.LogsModel" %>
        <%@ page import="com.disderm.dao.LogsDAO" %>
...
logsModel.set_type(request.getParameter("type"));
logsModel.set_date(request.getParameter("date"));
logsModel.set_user(request.getParameter("user"));
logsModel.set_des(request.getParameter("des"));
            Long insertID = logsDAO.insertLogs(logsModel);
            if (insertID != 0L) {
            ...
            <div class="app-main">
                ...
                <div class="app-main__outer">
                    <div class="app-main__inner">
                        ...
                        <%=MainView.getTopBar("Insertar logs", "Formulario de introducci&oacute;n para logs",visible_name,username,user_icon)%>
                        <!-- END HEADER TOP BAR -->
                                                ...
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        <div class="main-card mb-3 card">
                                                            <div class="card-body">
                                                                <!-- CONTENIDO -->
                                                                <form id="insertarLogsForm" name="insertarLogsForm">
                    <div class="position-relative row form-group"><label
                                                                        for="type"
                                                                        class="col-sm-2 col-form-label">Tipo Archivo</label>
                                                                    <div class="col-sm-10"><input name="type"
                                                                                                  id="type"
                            ...
                            <div class="position-relative row form-group"><label
                                                                    ...
                                                                    <div class="col-sm-10"><input name="date"
                                                                                                  id="date"
                                                                                                  placeholder="Nombre"
                                                                                                  type="text"
                                                                                                  class="form-control" >
                            ...
                            <div class="position-relative row form-group"><label
                                                                    ...
                                                                    <div class="col-sm-10"><input name="user"
                                                                                                  id="user"
                                                                                                  placeholder="Status"
                                                                                                  type="text"
                                                                                                  class="form-control" >
                            ...
                            <div class="position-relative row form-group"><label
                                                                    ...
                                                                    <div class="col-sm-10"><input name="des"
                                                                                                  id="des"
                                                                                                  placeholder="Date"
                                                                                                  type="text"
                                                                                                  class="form-control" >
                             ...
                             <div class="position-relative row">
                                                        <div class="col-sm-12">
                                                            <button class="btn btn-primary form-group" onclick="actionInsertarLogs()" style="width: inherit;">
                                                                Insertar
                                                            </button>
...
const form = $("#insertarLogsForm");
const lockModal = $("#lock-modal");
const loadingCircle = $("#loading-circle");var actionInsertarLogs  = function () {
