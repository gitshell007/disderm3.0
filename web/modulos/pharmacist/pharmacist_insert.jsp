...
<%@ page import="com.disderm.service.PharmacistService" %>
...
<%
    ...
    if (request.getParameter("isSubmit") != null) {
        ...
        PharmacistService PS = new PharmacistService();
        boolean resultService = PS.serviceInsertPharmacist(description);
        if (resultService) {
            ...
            <div class="app-main__inner">
                <div class="header-mobile-wrapper">
                    <div class="app-header__logo">
                        <a href="#" data-toggle="tooltip" data-placement="bottom" title="Disderm Admin"
                           class="logo-src"></a>
                ...
                <%=MainView.getTopBar("Pharmacist insert", "Formulario de introducci&oacute;n para Pharmacist", visible_name, username, user_icon)%>
                <!-- END HEADER TOP BAR -->
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="main-card mb-3 card">
                                                <div class="card-body">
                                                    <!-- CONTENIDO -->
                                                    <form id="pharmacistInsertForm" name="pharmacistInsertForm">
                                                        ...
                                                        <div class="position-relative row">
                                                            <div class="col-sm-12">
                                                                <button class="btn btn-primary form-group"
                                                                        onclick="pharmacistInsertAction()"
                                                                        style="width: inherit;">
                                                                    Insertar
                                                                </button>
...
<script>
    ...
    const form = $("#pharmacistInsertForm");
    const lockModal = $("#lock-modal");
    const loadingCircle = $("#loading-circle");
    var pharmacistInsertAction = function () {
    ...
    $(document).ready(() => {
        ...
        $('#avisoBorrarModal').on('hidden.bs.modal', function () {
            console.log('x');
            window.location.replace("/backoffice/modulos/pharmacist/tbl_custom_search_pharmacist.jsp");
        });
