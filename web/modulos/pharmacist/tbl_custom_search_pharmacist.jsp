            ...
            <div class="app-main">
                ...
                <div class="app-main__outer">
                    <div class="app-main__inner">
                        ...
                        <%=MainView.getTopBar("Pharmacist Consult", "Formulario de consulta para Pharmacist",visible_name,username,user_icon)%>
                        <!-- END HEADER TOP BAR -->
                                                ...
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        <div class="main-card mb-3 card">
                                                            <div class="card-body">
                                                                <!-- CONTENIDO -->
                                                                <table style="width: 100%;" id="tblPharmacist"
...
<script nomodule="" src="https://unpkg.com/ionicons@5.2.3/dist/ionicons/ionicons.js"></script>
        ...
        var table_Pharmacist = $('#tblPharmacist').DataTable({
            dom: 'Bfrtip',   
            processing: true,
            searching: true,
            serverSide: true,
            ...
            ajax: "/backoffice/services/pharmacist/getAllDataTable",
            aoColumns: [
...
pageLength: 20,buttons: [
 ...
 }); table_Pharmacist.on( 'select deselect', function () {
                                    var selectedRows = table_Pharmacist.rows( { selected: true } ).count();
                                    console.log('x' + selectedRows);
                                    table_Pharmacist.button( 0 ).enable( selectedRows === 1 );
                                    } );
                                 var PharmacistEdit = function ()
                                    {
                                        var selData =   table_Pharmacist.rows(".selected").data();
                                        window.location = "pharmacist_edit.jsp?id=" + selData[0][0];
                                    };

                                var PharmacistDelete = function ()
                                    {
                                        var selData =   table_Pharmacist.rows(".selected").data();
                                        window.location = "pharmacist_delete.jsp?id=" + selData[0][0];
                                    };
