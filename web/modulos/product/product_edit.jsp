...
<%
    ...
    if (request.getParameter("isSubmit") != null) {
        ...
        productModel = productdao.getProductModelByID(id);
    }
    ...
    <div class="app-main">
        ...
        <div class="app-main__outer">
            <div class="app-main__inner">
                ...
                <%=MainView.getTopBar("Product Edit", "Formulario de edicio&oacute;n para Product", visible_name, username, user_icon)%>
                <!-- END HEADER TOP BAR -->
                                                    ...
                                                    <form id="productEditForm" name="productEditForm" method="post">
                                                        ...
                                                        <div class="position-relative row form-group"><label
                                                            ...
                                                            <div class="col-sm-10"><input name="description"
                                                                                          ...
                                                                                          type="text"
                                                                                          class="form-control"
                                                                                          value="<%= productModel.get_description()%>">
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="position-relative row form-group"><label
                                                            ...
                                                            <div class="col-sm-10"><input name="cn"
                                                                                          id="cn"
                                                                                          placeholder="cn"
                                                                                          type="text"
                                                                                          class="form-control"
                                                                                          value="<%= productModel.get_cn()%>">
                                                            </div>
                                                        </div>
                                                        <div class="position-relative row">
                                                            <div class="col-sm-12">
                                                                <button class="btn btn-primary form-group"
                                                                        onclick="actionProductEdit()"
                                                                        style="width: inherit;">
                                                                    Editar
                                                                </button>
...
<script>
    ...
    function genericFetchImportSource(url, dropdown, mock) {
        importSource = <%=productModel.get_import_source_id()%>
    ...
    function genericFetchCategory(url, dropdown, mock) {
        category = <%=productModel.get_category_id()%>
            fetch(url).then(response => {
                response.json()
            }).catch(e => {
                return mock
    ...
    let dropdowncategory = $('#category_id');
    ...
    function loadSelectCategory() {
        ...
        genericFetchCategory(url_category, dropdowncategory);
    }
    var actionProductEdit = function () {
        $('#action').val('Edit');
