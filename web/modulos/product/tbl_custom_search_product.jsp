...
<head>
    ...
    <meta charset="UTF-8"/>
    <link rel="icon" href="/assets/images/dosaolivar/favicon/favicon.ico" type="image/ico"/>
    <title>Product</title>
    <!--<meta name="viewport"
    ...
    <div class="app-main">
        ...
        <div class="app-main__outer">
            <div class="app-main__inner">
                ...
                <%=MainView.getTopBar("Product Consult", "Formulario de consulta para Product", visible_name, username, user_icon)%>
                <!-- END HEADER TOP BAR -->
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="main-card mb-3 card">
                                                <div class="card-body">
                                                    <!-- CONTENIDO -->
                                                    <table style="width: 100%;" id="tblProduct"
...
<script>
    ...
    $(document).ready(function () {
        ...
        var table_Product = $('#tblProduct').DataTable({
            dom: 'Bfrtip',
            processing: true,
            searching: true,
            serverSide: true,
            ...
            ajax: "/backoffice/services/product/getAllDataTable",
            aoColumns: [
        ...
        table_Product.on('select deselect', function () {
            var selectedRows = table_Product.rows({selected: true}).count();
            console.log('x' + selectedRows);
            table_Product.button(0).enable(selectedRows === 1);
        });
        var ProductEdit = function () {
            var selData = table_Product.rows(".selected").data();
            window.location = "product_edit.jsp?id=" + selData[0][0];
        };

        var ProductDelete = function () {
            var selData = table_Product.rows(".selected").data();
            window.location = "product_delete.jsp?id=" + selData[0][0];
        };
