...
<%
    ...
    if (request.getParameter("isSubmit") != null) {
        if (request.getParameter("action").equals("Edit")) {
            ...
            Long pharmacy_id = Long.parseLong(request.getParameter("pharmacy_id"));
            pharmacydao.updatePharmacyString(map,pharmacy_id);
        ...
        pharmacyModel = pharmacydao.getPharmacyModelByID(id);
    }
    ...
    <div class="app-main">
        ...
        <div class="app-main__outer">
            <div class="app-main__inner">
                ...
                <%=MainView.getTopBar("Pharmacy Edit", "Formulario de edicio&oacute;n para Pharmacy", visible_name, username, user_icon)%>
                <!-- END HEADER TOP BAR -->
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="main-card mb-3 card">
                                                <div class="card-body">
                                                  <!-- CONTENIDO -->
                                                    <form id="pharmacyEditForm" name="pharmacyEditForm" method="post">
                                                        <div class="position-relative row form-group"><label
                                                            ...
                                                            <div class="col-sm-10"><input name="description"
                                                                                          ...
                                                                                          type="text"
                                                                                          class="form-control"
                                                                                          value="<%= pharmacyModel.get_description()%>">
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="position-relative row">
                                                            <div class="col-sm-12">
                                                                <button class="btn btn-primary form-group"
                                                                        onclick="actionPharmacyEdit()"
                                                                        style="width: inherit;">
                                                                    Editar
                                                                </button>
                                                                <input type="hidden" name="pharmacy_id" id="pharmacy_id" value="<%=id%>">
...
<script>
    ...
    const form = $("#pharmacyEditForm");
    const lockModal = $("#lock-modal");
    const loadingCircle = $("#loading-circle");
    var actionPharmacyEdit = function () {
        $('#action').val('Edit');
        var editForm = $('#pharmacyEditForm');
        editForm.submit();
    }

    $("pharmacyEditForm").submit(function(){

    });

    $(document).ready(() => {
        $("#pharmacyEditForm").validate({
            rules: {
                description:
                    {
                        required: true,
