...
<%@ page import="com.disderm.service.PharmacyService" %>
...
<%
    ...
    if (request.getParameter("isSubmit") != null) {
        ...
        boolean resultService = PS.serviceInsertPharmacy(description);
        if (resultService) {
    ...
    <div class="app-main">
        ...
        <div class="app-main__outer">
            <div class="app-main__inner">
                ...
                <%=MainView.getTopBar("Pharmacy insert", "Formulario de introducci&oacute;n para Pharmacy", visible_name, username, user_icon)%>
                <!-- END HEADER TOP BAR -->
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="main-card mb-3 card">
                                                <div class="card-body">
                                                    <!-- CONTENIDO -->
                                                    <form id="pharmacyInsertForm" name="pharmacyInsertForm">
...
<script>
    ...
    const form = $("#pharmacyInsertForm");
    const lockModal = $("#lock-modal");
    const loadingCircle = $("#loading-circle");
    var pharmacyInsertAction = function () {
    ...
    $(document).ready(() => {
        ...
        $('#avisoBorrarModal').on('hidden.bs.modal', function () {
            console.log('x');
            window.location.replace("/backoffice/modulos/pharmacy/tbl_custom_search_pharmacy.jsp");
        });
