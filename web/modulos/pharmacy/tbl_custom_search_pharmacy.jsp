            ...
            <div class="app-main">
                ...
                <div class="app-main__outer">
                    <div class="app-main__inner">
                        ...
                        <%=MainView.getTopBar("Pharmacy Consult", "Formulario de consulta para Pharmacy",visible_name,username,user_icon)%>
                        <!-- END HEADER TOP BAR -->
                                                ...
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        <div class="main-card mb-3 card">
                                                            <div class="card-body">
                                                                <!-- CONTENIDO -->
                                                                <table style="width: 100%;" id="tblPharmacy"
...
<script nomodule="" src="https://unpkg.com/ionicons@5.2.3/dist/ionicons/ionicons.js"></script>
        ...
        var table_Pharmacy = $('#tblPharmacy').DataTable({
            dom: 'Bfrtip',   
            processing: true,
            searching: true,
            serverSide: true,
            ...
            ajax: "/backoffice/services/pharmacy/getAllDataTable",
            aoColumns: [
...
pageLength: 20,buttons: [
 ...
 }); table_Pharmacy.on( 'select deselect', function () {
                                    var selectedRows = table_Pharmacy.rows( { selected: true } ).count();
                                    console.log('x' + selectedRows);
                                    table_Pharmacy.button( 0 ).enable( selectedRows === 1 );
                                    } );
                                 var PharmacyEdit = function ()
                                    {
                                        var selData =   table_Pharmacy.rows(".selected").data();
                                        window.location = "pharmacy_edit.jsp?id=" + selData[0][0];
                                    };

                                var PharmacyDelete = function ()
                                    {
                                        var selData =   table_Pharmacy.rows(".selected").data();
                                        window.location = "pharmacy_delete.jsp?id=" + selData[0][0];
                                    };
