    ...
    <div class="app-main">
        ...
        <div class="app-main__outer">
            <div class="app-main__inner">
                ...
                <%=MainView.getTopBar("Sales Consult", "Formulario de consulta para Sales", visible_name, username, user_icon)%>
                <!-- END HEADER TOP BAR -->
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="main-card mb-3 card">
                                                <div class="card-body">
                                                    <!-- CONTENIDO -->
                                                    <table style="width: 100%;" id="tblSales"
...
<script>
    ...
    $(document).ready(function () {
        ...
        var table_Sales = $('#tblSales').DataTable({
            dom: 'Bfrtip',
            processing: true,
            searching: true,
            serverSide: true,
            ...
            ajax: "/backoffice/services/sales/getAllDataTable",
            aoColumns: [
        ...
        table_Sales.on('select deselect', function () {
            var selectedRows = table_Sales.rows({selected: true}).count();
            console.log('x' + selectedRows);
            table_Sales.button(0).enable(selectedRows === 1);
        });
        var SalesEdit = function () {
            var selData = table_Sales.rows(".selected").data();
            window.location = "sales_edit.jsp?id=" + selData[0][0];
        };

        var SalesDelete = function () {
            var selData = table_Sales.rows(".selected").data();
            window.location = "sales_delete.jsp?id=" + selData[0][0];
        };
