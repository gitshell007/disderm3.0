...
<%
    ...
    HttpSession session_paciente_id = request.getSession();
    ...
    if (sBean != null) {
        if ((sBean.getUser() != null) && (sBean.getSession_id() != null)) {
            ...
            if (request.getParameter("isSubmit") != null) {
                pacienteModel.set_id(Long.valueOf(request.getParameter("id")));
                ...
                Long insertID = pacienteDAO.updatePacientepaciente(pacienteModel);
                if (insertID != 0L) {
    ...
    <div class="app-main">
        ...
        <div class="app-main__outer">
            <div class="app-main__inner">
                ...
                <%=MainView.getTopBar("Editar Paciente", "Edición de paciente", "admin", "admin", user_icon)%>
                <!-- END HEADER TOP BAR -->
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="main-card mb-3 card">
                                                    <div class="card-body">
                                                        <form id="editarPacienteForm" name="editarPacienteForm" method="POST">
                                                            <h3 class="card-title" style="font-weight: bold;">EDITAR PACIENTE</h3>
                                                            <div class="form-row">
                                                                <div class="col-md-8">
                                                                    <div class="position-relative form-group">
                                                                        <label for="apellidos" class="col-form-label"
                                                                               style="font-weight: bold;">Apellidos</label>
                                                                        <input name="apellidos" id="apellidos" value="<%=pacienteModel.get_apellidos()%>" type="text"
                                                                               class="form-control">
                                                                    </div>
                                                                </div>
                                                                <div class="col-md-4">
                                                                    <div class="position-relative form-group">
                                                                        ...
                                                                        <input name="identificador_pac" id="identificador_pac" value="<%=pacienteModel.get_identificador_pac()%>" type="text"
                                                                               class="form-control">
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="form-row">
                                                                <div class="col-md-6">
                                                                    <div class="position-relative form-group">
                                                                        ...
                                                                        <input name="nombre" id="nombre" value="<%=pacienteModel.get_nombre()%>" type="text"
                                                                               class="form-control">
                                                                    </div>
                                                                </div>
                                                                <div class="col-md-6">
                                                                    <div class="position-relative form-group">
                                                                        ...
                                                                        <input name="NIF" id="NIF" value="<%=pacienteModel.get_dni()%>" type="text"
                                                                               class="form-control">
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="form-row">
                                                                <div class="col-md-12">
                                                                    <div class="position-relative form-group">
                                                                        ...
                                                                        <input name="telefono" id="telefono" value="<%=pacienteModel.get_telefono()%>" type="text"
                                                                               class="form-control">
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="form-row">
                                                                <div class="col-md-12">
                                                                    <div class="position-relative form-group">
                                                                        ...
                                                                        <input name="correo" id="correo" value="<%=pacienteModel.get_correo()%>" type="text"
                                                                               class="form-control">
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <input id="id" value="<%=pacienteModel.get_id()%>" name="id" hidden>
                                                            <div class="position-relative row">
                                                                <div class="col-sm-12">
                                                                    <button class="btn btn-primary form-group"
                                                                            onclick="actionEditarPaciente()"
...
<script>
    ...
    const form = $("#editarPacienteForm");
    const lockModal = $("#lock-modal");
    const loadingCircle = $("#loading-circle");

    var actionEditarPaciente = function () {
